...
export const SkillsGrid: React.FC<SkillsGridProps> = ({ title = "Technical Arsenal", skills }) => {
    ...
    return (
        <section className="w-full py-24 px-4 max-w-7xl mx-auto bg-slate-50 border-y border-slate-100">
            {title && (
